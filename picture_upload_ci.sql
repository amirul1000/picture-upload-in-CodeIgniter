...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2020 at 07:28 AM
...
CREATE TABLE `article` (
  ...
  `description` text,
  `file_picture_1` varchar(256) DEFAULT NULL,
  `file_picture_2` varchar(256) DEFAULT NULL,
...
INSERT INTO `article` (`id`, `subject`, `description`, `file_picture_1`, `file_picture_2`, `created_at`, `updated_at`) VALUES
(2, 'test', 'test', 'uploads/images/article/arraow.jpg', 'uploads/images/article/bird.jpg', '2020-04-12 07:21:05', NULL),
(3, 'test2', 'test2', '', 'uploads/images/article/de.png', '2020-04-12 07:24:32', NULL);
